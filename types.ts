...
export type PetDetailQuery = { __typename?: 'Query' } & {
  pets: Array<
    { __typename?: 'Pet' } & Pick<Pet, 'id' | 'createdAt' | 'name'> & {
 ...
 * });
 */
export function usePetDetailQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<PetDetailQuery, PetDetailQueryVariables>
) {
  return ApolloReactHooks.useQuery<PetDetailQuery, PetDetailQueryVariables>(
    PetDetailDocument,
    baseOptions
  )
}

export function usePetDetailLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<PetDetailQuery, PetDetailQueryVariables>
) {
  return ApolloReactHooks.useLazyQuery<PetDetailQuery, PetDetailQueryVariables>(
    PetDetailDocument,
    baseOptions
  )
}
...
export type PetDetailQueryResult = ApolloReactCommon.QueryResult<
  PetDetailQuery,
